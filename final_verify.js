...
const GLOBAL_IMAGE_POOL = [
    ...
    '1522202176988-66273c2fd55f', '1532054241088-402b4150db33', '1554284126-aa88f22d8b74', '1558017487-06bf9f82613a',
...
async function check(id) {
    return new Promise(r => {
        const url = 'https://images.unsplash.com/photo-' + id + '?auto=format&fit=crop&q=80&w=10';
...
async function run() {
    for (const id of GLOBAL_IMAGE_POOL) await check(id);
    console.log('DONE');
}
run();
